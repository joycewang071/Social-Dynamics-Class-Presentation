...
Description:
  - Parses local PDF files and writes extracted text into UTF-8 encoded TXT files.
  - Uses pdfminer.six to aggregate text boxes and keeps only Chinese characters
    (U+4E00–U+9FA5) while stripping other characters.

Inputs:
  - Source PDFs are organized under: C:/Users/10292/Downloads/news/{category}/{sub}/{file.pdf}

Outputs:
  - Extracted TXT files are written to: C:/Users/10292/Downloads/news_txt/{sub}__{filename}.txt
